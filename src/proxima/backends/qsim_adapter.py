...
class QsimAdapter(BaseBackendAdapter):
    ...
    def is_available(self) -> bool:
        ...
        """
        return (
            self._qsimcirq_available is True
            and self._cirq_available is True
        )
    ...
    def validate_circuit(self, circuit: Any) -> ValidationResult:
        ...
        if has_mid_circuit_measurement:
            return ValidationResult(
                ...
                details={"suggestion": "Move measurements to end of circuit or use Cirq simulator"},
            )
    ...
    def execute(self, circuit: Any, options: dict[str, Any] | None = None) -> ExecutionResult:
        ...
        seed = options.get("seed", self._config.seed)
        ...
        try:
            ...
            num_threads = options.get("num_threads") or self._get_optimal_thread_count(qubit_count)
