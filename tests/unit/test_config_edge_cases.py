...
class TestConfigValidation:
    ...
    def test_validate_verbosity_valid(self):
        ...
        from proxima.config.validation import validate_verbosity, ValidationResult
    ...
    def test_validate_timeout_negative(self):
        ...
        from proxima.config.validation import validate_timeout, ValidationResult
    ...
    def test_validate_url_missing_scheme(self):
        ...
        from proxima.config.validation import validate_url, ValidationResult
    ...
    def test_validate_memory_threshold_low_warning(self):
        ...
        from proxima.config.validation import validate_memory_threshold, ValidationResult
...
class TestConfigExportImport:
    ...
    def test_export_yaml(self):
        """Test YAML export."""
        from proxima.config.export_import import export_config, ExportFormat
    ...
    def test_export_no_redact(self):
        ...
        from proxima.config.export_import import export_config, ExportFormat, ExportOptions
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            export_config(
                config, output_path, ExportFormat.YAML,
    ...
    def test_backup_list(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Create a backup
            backup_info = create_backup(config_path, backup_dir)
...
class TestSecrets:
    ...
    def test_secret_manager_fallback(self):
        ...
        from proxima.config.secrets import SecretManager, SecretBackend
...
class TestConfigMigration:
    ...
    def test_auto_migrate(self):
        ...
        from proxima.config.migration import auto_migrate, CURRENT_VERSION
...
class TestConfigSchema:
    ...
    def test_section_info_to_dict(self):
        ...
        from proxima.config.schema import SectionInfo, FieldInfo, FieldType
    ...
    def test_generate_json_schema(self):
        ...
        from proxima.config.schema import SectionInfo, FieldInfo, FieldType, generate_json_schema
    ...
    def test_generate_completion_data(self):
        ...
        from proxima.config.schema import SectionInfo, FieldInfo, FieldType, generate_completion_data
...
class TestConfigIntegration:
    ...
    def test_full_workflow_export_import_validate(self):
        ...
        from proxima.config.export_import import export_config, import_config, ExportFormat
        from proxima.config.validation import validate_settings
...
class TestConfigEdgeCases:
    ...
    def test_very_long_string_value(self):
        ...
        from proxima.config.validation import validate_path, ValidationResult
