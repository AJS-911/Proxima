...
class TestMemoryMonitor:
    ...
    def test_memory_thresholds_get_level(self) -> None:
        ...
        from proxima.resources.monitor import MemoryThresholds, MemoryLevel
    ...
    def test_memory_snapshot(self) -> None:
        ...
        from proxima.resources.monitor import MemorySnapshot, MemoryLevel
...
class TestConsentManager:
    ...
    def test_consent_request_creation(self) -> None:
        ...
        from proxima.resources.consent import ConsentRequest, ConsentCategory
    ...
    def test_consent_record(self) -> None:
        ...
        from proxima.resources.consent import ConsentRecord, ConsentLevel, ConsentCategory
...
class TestExecutionControl:
    ...
    def test_controller_initial_state(self) -> None:
        ...
        from proxima.resources.control import ExecutionController, ControlState
...
class TestResourceIntegration:
    ...
    def test_controller_with_checkpoint_manager(self) -> None:
        ...
        from proxima.resources.control import ExecutionController, CheckpointManager
    ...
    def test_control_event(self) -> None:
        ...
        from proxima.resources.control import ExecutionController, ControlState, ControlEvent
